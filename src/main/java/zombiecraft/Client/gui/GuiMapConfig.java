...
public class GuiMapConfig extends GuiContainer {
	...
	public GuiMapConfig (InventoryPlayer inventoryPlayer) {
		super(new ContainerMapConfig(inventoryPlayer));
		nbtSendCache.setTag("mapData", new NBTTagCompound());
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "ZC Level Configuration" + (guiCur.equals("main") ? "" : " - SubGUI: " + guiCur), xStart+7, yStart-9, 16777215);
		...
		if (guiCur.equals("main")) {
			...
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Custom Lighting", xStart+7, yStart+8, 16777215);
			
			//this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Current Vals 0-15: " + vals, xStart+5, yStart+6+40, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Lock sky: ", xStart+7, yStart+8+yEleSize*2, 16777215);
			
			//subguis
			//this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Wave ", xStart+7, yStart+8+130, 16777215);
			...
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Default Mob", xStart+7, yStart+8, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Starting count", xStart+7, yStart+8+yEleSize*2, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Count multiplier", xStart+7+x2, yStart+8+yEleSize*2, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Starting health", xStart+7, yStart+8+yEleSize*4, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Health multiplier", xStart+7+x2, yStart+8+yEleSize*4, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Starting speed", xStart+7, yStart+8+yEleSize*6, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Random speed", xStart+7+x2, yStart+8+yEleSize*6, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Speed multiplier", xStart+7+x3, yStart+8+yEleSize*6, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Speed max", xStart+7+x4, yStart+8+yEleSize*6, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Move Lead Dist", xStart+7, yStart+8+yEleSize*8, 16777215);
		}
	}
    ...
    public void initGui()
    {
        ...
        if (guiCur.equals("main")) {
        	addButton("close", new GuiButton(CMD_CLOSE, xStart + xSize - guiPadding - btnWidth, yStart + ySize - guiPadding - btnHeight, btnWidth, btnHeight, "Save & Close"));
        } else {
        	addButton("close", new GuiButton(CMD_CLOSE, xStart + xSize - guiPadding - btnWidth, yStart + ySize - guiPadding - btnHeight, btnWidth, btnHeight, "Back"));
        }
        ...
        if (guiCur.equals("main")) {
	        ...
	        addTextBox(LevelConfig.nbtStrCustomLightingMode, new GuiTextFieldZC(LevelConfig.nbtStrCustomLightingMode, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + 55, yStartPadded+btnHeight-8, 220, 20));
	        ...
	        addTextBox(LevelConfig.nbtStrCustomTimeVal, new GuiTextFieldZC(LevelConfig.nbtStrCustomTimeVal, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + 55, yStartPadded+btnHeight*3-8, 220, 20));
        } else if (guiCur.equals(GUI_SUBGUI_WAVE)) {
        	
        	int x2 = 90;
        	
        	addTextBox(LevelConfig.nbtStrWaveDefaultMobSpawned, new GuiTextFieldZC(LevelConfig.nbtStrWaveDefaultMobSpawned, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeight-8, 220, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpawnCountBase, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpawnCountBase, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeight*3-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpawnCountMultiplier, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpawnCountMultiplier, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + x2, yStartPadded+btnHeight*3-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveHealth, new GuiTextFieldZC(LevelConfig.nbtStrWaveHealth, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeight*5-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveHealthAmp, new GuiTextFieldZC(LevelConfig.nbtStrWaveHealthAmp, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + x2, yStartPadded+btnHeight*5-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpeedBase, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpeedBase, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeight*7-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpeedRand, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpeedRand, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + x2, yStartPadded+btnHeight*7-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpeedAmp, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpeedAmp, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + x2*2, yStartPadded+btnHeight*7-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveSpeedAmpMax, new GuiTextFieldZC(LevelConfig.nbtStrWaveSpeedAmpMax, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + x2*3, yStartPadded+btnHeight*7-8, 60, 20));
        	addTextBox(LevelConfig.nbtStrWaveMoveLeadDist, new GuiTextFieldZC(LevelConfig.nbtStrWaveMoveLeadDist, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeight*9-8, 60, 20));
        }
        
        //NBTTagCompound data = new NBTTagCompound();
        nbtSendCache.setBoolean("sync", true);
        ZombieCraftMod.eventChannel.sendToServer(PacketHelper.createPacketForNBTHandler("MapConfig", ZombieCraftMod.eventChannelName, nbtSendCache));
        //PacketHelper.sendClientPacket(EventHandlerPacket.getNBTPacket(nbtSendCache, "MapConfig"));
        updateGuiElements();
    }
