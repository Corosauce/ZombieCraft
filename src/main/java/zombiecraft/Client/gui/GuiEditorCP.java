...
public class GuiEditorCP extends GuiScreen
{
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.drawCenteredString(FMLClientHandler.instance().getClient().fontRenderer, "ZC Menu", ((this.width - this.xSize) / 2) + xOffset + 50, var6 - 10, 16777215);
        if (ZCGame.instance().mapMan.editMode) this.drawCenteredString(FMLClientHandler.instance().getClient().fontRenderer, "Level Info", 0 + 45, var6 - 10, 16777215);
    }
    ...
    public void initGui()
    {
        ...
        this.textboxWorldName = new GuiTextField(FMLClientHandler.instance().getClient().fontRenderer, startX2, startY + div*0 + var1, 90, 20);
