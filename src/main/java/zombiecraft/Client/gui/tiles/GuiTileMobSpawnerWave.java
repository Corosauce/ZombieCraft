...
public class GuiTileMobSpawnerWave extends GuiTileBase {
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "ZC Mob Spawner" + (guiCur.equals("main") ? "" : " - SubGUI: " + guiCur), xStart+7, yStart-9, 16777215);
		...
		if (guiCur.equals("main")) {
			this.drawStringRightAligned(FMLClientHandler.instance().getClient().fontRenderer, "Custom Entity Spawning", xStart+xSize/3, yStart2+yDiv, 16777215);
			this.drawStringRightAligned(FMLClientHandler.instance().getClient().fontRenderer, "Custom Entity String", xStart+xSize/3, yStart2+yDiv*2, 16777215);
			
			this.drawStringRightAligned(FMLClientHandler.instance().getClient().fontRenderer, "Spawn Delay Ticks", xStart+xSize/3, yStart2+yDiv*3, 16777215);
			this.drawStringRightAligned(FMLClientHandler.instance().getClient().fontRenderer, "Added Random Ticks", xStart+xSize/3, yStart2+yDiv*4, 16777215);
			this.drawStringRightAligned(FMLClientHandler.instance().getClient().fontRenderer, "First Spawn Delayed", xStart+xSize/3, yStart2+yDiv*5, 16777215);
			
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Spawn Rules", xStart + xSize - guiPadding - btnWidth, yStart+8+130, 16777215);
		}
		if (guiCur.equals(tEnt.CMD_GUIMODE_STR_WATCH)) {
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "X", xStart+42, yStart+36, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Y", xStart+42, yStart+60, 16777215);
			this.drawString(FMLClientHandler.instance().getClient().fontRenderer, "Z", xStart+42, yStart+84, 16777215);
		}
	}
    ...
    public void initGui()
    {
        ...
        if (guiCur.equals("main")) {
	        ...
	        addTextBox(tEnt.nbtStrCustomSpawn, new GuiTextFieldZC(tEnt.nbtStrCustomSpawn, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + rightStart, yStartPadded+btnHeightAndPadding*1, 180, 20));
	        addTextBox(tEnt.nbtStrSpawnDelay, new GuiTextFieldZC(tEnt.nbtStrSpawnDelay, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + rightStart, yStartPadded+btnHeightAndPadding*2, 30, 20));
	        addTextBox(tEnt.nbtStrSpawnDelayRand, new GuiTextFieldZC(tEnt.nbtStrSpawnDelayRand, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded + rightStart, yStartPadded+btnHeightAndPadding*3, 30, 20));
        	...
        	addTextBox(tEnt.nbtStrProxDist, new GuiTextFieldZC(tEnt.nbtStrProxDist, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*1, 30, 20));
        	...
        	addTextBox(tEnt.nbtStrWatchX, new GuiTextFieldZC(tEnt.nbtStrWatchX, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*1, 30, 20));
        	addTextBox(tEnt.nbtStrWatchY, new GuiTextFieldZC(tEnt.nbtStrWatchY, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*2, 30, 20));
        	addTextBox(tEnt.nbtStrWatchZ, new GuiTextFieldZC(tEnt.nbtStrWatchZ, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*3, 30, 20));
        } else if (guiCur.equals(tEnt.CMD_GUIMODE_STR_WAVE)) {
        	...
        	addTextBox(tEnt.nbtStrWaveMin, new GuiTextFieldZC(tEnt.nbtStrWaveMin, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*1, 30, 20));
        	addTextBox(tEnt.nbtStrWaveMax, new GuiTextFieldZC(tEnt.nbtStrWaveMax, FMLClientHandler.instance().getClient().fontRenderer, xStartPadded, yStartPadded+btnHeightAndPadding*2, 30, 20));
        }
        
        NBTTagCompound data = new NBTTagCompound();
        data.setBoolean("sync", true);
        ZombieCraftMod.eventChannel.sendToServer(PacketHelper.createPacketForTEntCommand(tEnt, data));
        updateGuiElements();
    }
	...
	protected void actionPerformed(GuiButton var1)
    {
        ...
        if (sendPacket) {
            ...
            //ZombieCraftMod.eventChannel.sendToServer(PacketHelper.createPacketForNBTHandler("MapConfig", nbtSendCache));
            ZombieCraftMod.eventChannel.sendToServer(PacketHelper.createPacketForTEntCommand(tEnt, nbtSendCache));
        }
