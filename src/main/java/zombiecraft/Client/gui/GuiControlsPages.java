...
public class GuiControlsPages extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
        	System.out.println(this.options.getKeyDisplayString(var3));
            this.buttonList.add(new GuiButton(var3, var2 + counter % 2 * 160, this.height / 6 + 24 * (counter >> 1), 70, 20, this.options.getKeyDisplayString(var3)));
            counter++;
        }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            ((GuiButton)this.buttonList.get(var2)).displayString = this.options.getKeyDisplayString((page*elementsPerPage)+var2);
        }
        ...
        else if (par1GuiButton.id == 201)
        {
        	if (page > 0) page--;
            //this.mc.displayGuiScreen(this.parentScreen);
            FMLClientHandler.instance().displayGuiScreen(ZCClientTicks.player, new GuiControlsPages(null, mc.gameSettings, page));
        }
        ...
        else
        {
            ...
            par1GuiButton.displayString = "> " + this.options.getKeyDisplayString(par1GuiButton.id) + " <";
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(FMLClientHandler.instance().getClient().fontRenderer, this.screenTitle, this.width / 2, 20, 16777215);
        ...
        for (int var5 = elementStart; var5 < elementEnd; ++var5)
        {
            ...
            {
                if (var7 != var5 && this.options.keyBindings[var5].getKeyCode() == this.options.keyBindings[var7].getKeyCode())
                {
                    var6 = true;
                }
            }
            ...
            {
                ((GuiButton)this.buttonList.get(counter)).displayString = "\u00a7c" + this.options.getKeyDisplayString(var5);
            }
            else
            {
            	try {
            		((GuiButton)this.buttonList.get(counter)).displayString = this.options.getKeyDisplayString(var5);
            	} catch (Exception ex) {
            		ex.printStackTrace();
            	}
            }
