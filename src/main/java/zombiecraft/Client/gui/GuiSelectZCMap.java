...
public class GuiSelectZCMap extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        FMLClientHandler.instance().getClient().fontRenderer.drawString(screenTitle, 12, 20, 16777215);
        ...
        if (saveList.size() > 0) {
	        ...
	        if (zsr != null) {
	        	...
	        	FMLClientHandler.instance().getClient().fontRenderer.drawString(zsr.text, 180 + 20, 20, 16777215);
	        	
	        	String str = zsr.getExtraInfo();
	        	if (str != null) {
	        		FMLClientHandler.instance().getClient().fontRenderer.drawSplitString(str, 180 + 20, 40, 220, 16777215);
	        	}
	        }
        }
