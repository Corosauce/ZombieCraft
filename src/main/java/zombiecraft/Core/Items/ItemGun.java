...
public class ItemGun extends Item
{
    ...
    public int getFireDelay(ItemStack stack, World var2, EntityPlayer var3) {
    	if (CoroUtilEntity.getName(var3).contains("fakePlayer")) {
    		BaseEntAI entAI = (BaseEntAI)OldUtil.playerToCompAILookup.get(CoroUtilEntity.getName(var3));
    ...
    public int tryItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
    	...
    	int useBulletResult = ZCUtil.useItemInInventory(var3, CoroUtilEntity.getName(var3), this);
    	
    	if (var3.capabilities.isCreativeMode/* || (CoroUtilEntity.getName(var3) == "fakePlayer")*/) {
    		if (curClipAmount == 0) {
    	...
    	if (useBulletResult > 0) {
	        ...
	        if (curClipAmount <= 0) {
	        	...
	        	int ammoCount = ZCUtil.getAmmoData(CoroUtilEntity.getName(var3), ammoType.ordinal());
	        	if (ammoCount == 0) {
	        		curClipAmount = -1;
	        	} else {
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    	...
    	//INSTANCE HANDLING
    	if (var3 == null || CoroUtilEntity.getName(var3).contains("fakePlayer")) {
    ...
    public int tryItemRightClick2(ItemStack var1, World var2, EntityPlayer var3) {
        ...
        var10 = ZCUtil.useItemInInventory(var3, CoroUtilEntity.getName(var3), this);
        
        //System.out.println("CoroUtilEntity.getName(var3): " + CoroUtilEntity.getName(var3));
