...
public class EntityBullet extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isRemote && !this.serverSoundPlayed && this.owner != FMLClientHandler.instance().getClient().thePlayer)
        {
    ...
    public boolean tryHit(Entity var4, Vec3 vec) {
        ...
        if (var3 != null)
        {
            Block var9 = this.worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ);

            if ((var3.entityHit != null && var3.entityHit != lastHit && !var3.entityHit.isDead && (var3.entityHit instanceof EntityLivingBase) && ((EntityLivingBase)var3.entityHit).getHealth() > 0) || (var9 != Blocks.tallgrass && !ZCUtil.shouldBulletPassThrough(this, var9)))
            {
                ...
                else
                {
                    ...
                    if (ZombieCraftMod.bulletsDestroyGlass && (this.inTile == Blocks.glass || this.inTile == Blocks.glass_pane))
                    {
                        Block var19;

                        if (this.inTile == Blocks.glass)
                        {
                            var19 = Blocks.glass;
                        }
                        else
                        {
                            var19 = Blocks.glass_pane;
                        }
                        ...
                        this.worldObj.setBlock(this.xTile, this.yTile, this.zTile, Blocks.air);
