...
public class ZCCommonProxy implements IGuiHandler
{
    ...
    public void init(ZombieCraftMod pMod)
    {
		...
		LanguageRegistry.instance().addStringLocalization("itemGroup.ZombieCraft", "ZombieCraft Items");
		LanguageRegistry.instance().addStringLocalization("death.zc.zombie", "%1$s died by a zombie"); //LanguageRegistry.instance().addStringLocalization("death.moon", "%1$s was sucked to the moon"); where "moon" was my deathsource deathtype and %1$s becomes playername
		LanguageRegistry.instance().addStringLocalization("deathScreen.spectate", "Spectate");
