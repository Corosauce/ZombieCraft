...
public class TileEntityMobSpawnerOpen extends TileEntity implements SchematicData
{
    ...
    public TileEntityMobSpawnerOpen()
    {
        this.delay = 20;
        watchX = xCoord;
		watchY = yCoord+1;
    ...
    public void updateEntity()
    {
        ...
        if (isActive())
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                int var7 = 3 * ZCGame.instance().getPlayerCount();
