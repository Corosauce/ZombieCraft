...
public class EntityImpFireball extends EntityFireball
{
    ...
    public EntityImpFireball(World par1World)
    {
        super(par1World);
    ...
    public EntityImpFireball(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        super(par1World);
        this.setSize(1.0F, 1.0F);
