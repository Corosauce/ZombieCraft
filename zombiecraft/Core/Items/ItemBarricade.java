...
public class ItemBarricade extends Item
{
    ...
    public ItemBarricade(int par1, Material par2Material)
    {
        super(par1);
    ...
    public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block)
    {
        ...
        par0World.setBlock(par1, par2, par3, par5Block.blockID, par4, 0); //flag to not update
        par0World.setBlock(par1, par2 + 1, par3, par5Block.blockID, 8 | (var12 ? 1 : 0), 2); //flag to update, now that other is placed
